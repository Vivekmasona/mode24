...
vivekmasonaDownDiv.innerHTML+="<span style='position:absolute;top:0px;left:0px;color:#ff0000;font-size:25px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>❌;</span><iframe src='https://pgmoviepro.blogspot.com/' height='100%' width='100%'></iframe><ul id='listurl'>";
